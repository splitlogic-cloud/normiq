...
function InviteContent() {
  ...
  const card: React.CSSProperties = {
    background: 'white', border: '1px solid #E0DDD6', borderRadius: 10,
  ...
  if (status === 'invalid') return (
    <div style={card}>
      ...
      <p style={{ fontSize: 14, color: '#888', lineHeight: 1.8, marginBottom: 24 }}>Den här länken är inte giltig eller har gått ut.</p>
  ...
  if (status === 'accepted') return (
    <div style={card}>
      ...
      <p style={{ fontSize: 14, color: '#888', lineHeight: 1.8, marginBottom: 24 }}>Den här inbjudan har redan använts.</p>
