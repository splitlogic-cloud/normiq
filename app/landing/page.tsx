    ...
    <div style={{ background: '#F5F3EE', minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-link { font-family: 'DM Mono', monospace; font-size: 11px; color: #888; text-decoration: none; letter-spacing: .08em; text-transform: uppercase; transition: color .2s; white-space: nowrap; }
        ...
        .flow-box { flex: 1; min-width: 148px; border: 1px solid #E0DDD6; border-radius: 6px; padding: 22px 18px; background: #F9F8F5; }
      ...
      <section className="hero-grid" style={{ maxWidth: 1100, margin: '0 auto', padding: '96px 48px 80px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
        <div>
          ...
          <div className="a4 hero-tags mono" style={{ fontSize: 11, color: '#AAA', letterSpacing: '.05em', display: 'flex', gap: 14, flexWrap: 'wrap' }}>
      ...
      {/* SOCIAL PROOF */}
      <section style={{ borderTop: '1px solid #E0DDD6', borderBottom: '1px solid #E0DDD6', background: 'white' }}>
        <div className="source-strip" style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 48px', display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div className="flow-wrap" style={{ display: 'flex', alignItems: 'flex-start', gap: 0, overflowX: 'auto', paddingBottom: 8 }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', flex: 1, minWidth: 148 }}>
          ...
          <div style={{ maxWidth: 460, margin: '0 auto' }}>
            <div style={{ background: 'white', border: '1.5px solid #0A0A0C', borderRadius: 8, padding: '40px 36px', position: 'relative' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginBottom: 4 }}>
                <span className="cg" style={{ fontSize: 56, fontWeight: 300, color: '#0A0A0C', letterSpacing: '-.02em', lineHeight: 1 }}>
              ...
              <p className="mono" style={{ fontSize: 10, color: '#CCC', textAlign: 'center', marginTop: 14 }}>
                Inget kreditkort · Avsluta när som helst
              </p>
            </div>
          </div>
      ...
      <footer style={{ borderTop: '1px solid #1a1a1c', padding: '32px 48px', background: '#0A0A0C' }}>
        <div className="footer-inner" style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
          ...
          <div className="footer-links mono" style={{ fontSize: 11, color: '#444', display: 'flex', gap: 24, flexWrap: 'wrap' }}>
