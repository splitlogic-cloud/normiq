...
export default function Home() {
  ...
  <button
    onClick={() => setSidebarOpen(v => !v)}
    style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 8, borderRadius: 6, color: '#AAA' }}
    onMouseEnter={e => (e.currentTarget.style.color = '#0A0A0C')}
    onMouseLeave={e => (e.currentTarget.style.color = '#AAA')}
  >
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
    {messages.length > 0 && (
      <button
        onClick={() => setMessages([])}
        className="mono"
        style={{ background: 'none', border: '1px solid #E0DDD6', borderRadius: 6, padding: '6px 16px', fontSize: 11, color: '#AAA', cursor: 'pointer', letterSpacing: '.08em', textTransform: 'uppercase' }}
    ...
    <button
      ...
      className="mono"
      style={{ background: 'none', border: '1px solid #E0DDD6', borderRadius: 6, padding: '6px 16px', fontSize: 11, color: '#AAA', cursor: 'pointer', letterSpacing: '.08em', textTransform: 'uppercase' }}
      onMouseEnter={e => { (e.currentTarget.style.borderColor = '#C0321A'); (e.currentTarget.style.color = '#C0321A') }}
      onMouseLeave={e => { (e.currentTarget.style.borderColor = '#E0DDD6'); (e.currentTarget.style.color = '#AAA') }}
    >
      Logga ut
    </button>
