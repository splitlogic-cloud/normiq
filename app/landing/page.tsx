...
export default function Landing() {
  ...
  const faqs = [
    ...
    { q: 'Kan jag använda Normiq i ett byråteam?', a: 'Ja. Team-planen täcker upp till 10 användare och är designad för att team ska kunna arbeta konsekvent.' },
    ...
    <div style={{ background: '#F5F3EE', minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .label { font-family: 'DM Mono', monospace; font-size: 10px; letter-spacing: .16em; text-transform: uppercase; color: #C0321A; display: flex; align-items: center; gap: 10px; margin-bottom: 18px; }
        ...
        <div className="a5" style={{ display: 'flex', justifyContent: 'center' }}>
          <div className="mock-wrap">
            <div className="mock-topbar">
              ...
              <span className="mono" style={{ fontSize: 11, color: '#CCC', marginLeft: 8, letterSpacing: '.06em' }}>Normiq · Skatt och Redovisning</span>
            </div>
            ...
            {[
              {
                ...
                a: 'Utdelning upp till gränsbeloppet beskattas med 20% i kapital. Gränsbeloppet 2026 består av: (1) Grundbelopp 4 IBB = 322 400 kr. (2) Lönebaserat utrymme: 50% av löner över 8 IBB (644 800 kr). (3) Sparat utdelningsutrymme från tidigare år. (4) Ränta på omkostnadsbelopp över 100 000 kr.',
                simplified: 'Du kan ta ut lågbeskattad utdelning (20%) upp till ditt gränsbelopp. Grundbeloppet är 322 400 kr 2026 — det får alla kvalificerade ägare. Har bolaget höga löner kan du lägga till 50% av löner som överstiger 644 800 kr.',
                sources: 'IL 57:11 · IL 57:19 · IL 57:20',
                risk: 'HÖG', riskColor: '#A02818',
              },
              {
                q: 'Vad gäller för representation avseende moms?',
                a: 'Momsavdrag för representation medges på underlag om högst 300 kr exkl. moms per person. Enbart mat (12% moms): max 36 kr/person. Mat och alkohol — schablon: 46 kr/person om kostnad överstiger 300 kr exkl. moms och debiterad moms är minst 46 kr. Fr.o.m. 1 april 2026 gäller ny schablon om 33 kr/person om restaurangen tillämpar 6% livsmedelsmoms.',
                simplified: 'Du kan välja mellan två metoder när måltiden innehåller både mat och alkohol. Antingen schablonen (46 kr/person) om notan överstiger 300 kr exkl. moms — eller proportionering utifrån faktiska kostnader. Enbart mat: max 36 kr/person.',
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 72 }}>
            ...
            <p style={{ fontFamily: 'Georgia, serif', fontSize: 16, color: '#555', lineHeight: 1.8, maxWidth: 620, margin: '0 auto' }}>
              Normiq lär sig av varje verifierat svar, hanterar kontering direkt från kvitto till Fortnox, och ger byråer ett komplett arbetsflöde för alla klienter under ett tak.
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 2, marginBottom: 72 }}>
            {[
              { num: '01', title: 'Tax Brain', desc: 'Klistra in ett kvitto eller hämta transaktioner från Fortnox. Tax Brain föreslår BAS-konto, momskod och lagrum deterministiskt — inte av AI-gissning.', items: ['Kvitto till kontering på sekunder', 'Deterministisk momsberäkning', 'Godkänn, justera eller avvisa', 'Skicka direkt till Fortnox'] },
              { num: '02', title: 'Byråvy', desc: 'Hantera alla klienter under ett tak. Varje klient har egen Fortnox-koppling, transaktionshistorik och aktivitetslogg. Byt klient med ett klick.', items: ['Obegränsat antal klienter', 'Fortnox och Bokio OAuth-integration', 'Klientspecifik historik och statistik', 'Teammedlemmar med rollstyrning'] },
              { num: '03', title: 'Kunskapsbibliotek', desc: 'Normiq lär sig av varje verifierat svar. Revisorverifierade svar återanvänds automatiskt — liknande frågor besvaras direkt utan att belasta AI:n.', items: ['Revisor verifierar och godkänner svar', 'Automatisk återanvändning vid 88% likhet', 'Anonymt frågeregister och FAQ', 'Bygg byråns egen kunskapsbas'] },
            ].map((col, i) => (
              <div key={i} style={{ background: '#111113', border: '1px solid #1e1e20', padding: '32px 28px' }}>
                ...
                <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 22, fontWeight: 600, color: 'white', marginBottom: 14, letterSpacing: '-.01em' }}>{col.title}</div>
              ...
              <div style={{ background: 'white', borderRadius: 10, overflow: 'hidden', border: '1px solid #E0DDD6' }}>
                ...
                <div style={{ padding: '12px 22px', borderTop: '1px solid #F0EDE6', background: '#FAFAF8' }}>
                  <div style={{ fontFamily: 'Georgia, serif', fontSize: 12, color: '#888', lineHeight: 1.75 }}>
                    Representation — avdragsrätt saknas för inkomstskatt (IL 16:2). Enbart mat 12% moms: max avdragsgill moms 36 kr/person (12% av 300 kr underlag).
                  </div>
                </div>
              </div>
              <div style={{ background: '#111113', border: '1px solid #1e1e20', borderRadius: 10, padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 14 }}>
                <div style={{ width: 32, height: 32, borderRadius: 6, background: 'rgba(46,102,68,.15)', border: '1px solid rgba(46,102,68,.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <span style={{ color: '#2E6644', fontSize: 14 }}>✓</span>
                </div>
                <div>
                  <div style={{ fontFamily: 'Georgia, serif', fontSize: 13, color: 'rgba(255,255,255,.6)', marginBottom: 2 }}>
                    Verifierat av Anna Lindström · sparas i biblioteket
                  </div>
                  <div style={{ fontFamily: 'DM Mono, monospace', fontSize: 10, color: '#333', letterSpacing: '.04em' }}>
                    Nästa liknande fråga besvaras direkt utan AI-anrop
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="priser" style={{ background: 'white', borderTop: '1px solid #E0DDD6', borderBottom: '1px solid #E0DDD6', padding: '88px 48px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14 }}>
            {[
              { name: 'Solo', price: billingAnnual ? '124' : '149', period: billingAnnual ? 'kr/mån, faktureras årsvis' : 'kr/mån', desc: 'För dig som driver eget bolag eller jobbar självständigt med skatt och redovisning.', features: ['1 användare', 'Advisor — källbaserade svar', 'Riskklassning per fråga', 'Klickbara lagrum'], addon: 'Tax Brain tillkommer +100 kr/mån', cta: 'Kom igång gratis', href: '/register?plan=solo', featured: false },
              { name: 'Team', price: billingAnnual ? '666' : '799', period: billingAnnual ? 'kr/mån, faktureras årsvis' : 'kr/mån', desc: 'För byråer och ekonomiteam som vill arbeta konsekvent med källbaserade svar.', features: ['Upp till 10 användare', 'Advisor — källbaserade svar', 'Tax Brain ingår', 'Kunskapsbibliotek', 'Byråvy med klienthantering', 'Prioriterad support'], addon: null, cta: 'Starta Team', href: '/register?plan=team', featured: true },
              { name: 'Byrå', price: '299', period: 'kr/klient/mån', desc: 'För redovisningsbyråer med flera klienter. Betala per klient, inte per användare.', features: ['Obegränsade användare', 'Allt i Team', 'Fortnox och Bokio-integration', 'Kunskapsbibliotek', 'Klientspecifik historik'], addon: null, cta: 'Kontakta oss', href: 'mailto:hej@normiq.se', featured: false },
            ].map((plan, i) => (
              <div key={i} className={`price-card ${plan.featured ? 'featured' : ''}`}>
                ...
                <div style={{ fontSize: 14, color: '#888', lineHeight: 1.7, marginBottom: plan.addon ? 12 : 28, minHeight: 44 }}>{plan.desc}</div>
                {plan.addon && (
                  <div style={{ fontSize: 12, color: '#C0321A', fontFamily: 'DM Mono, monospace', letterSpacing: '.04em', marginBottom: 20, padding: '7px 10px', background: '#FDF4F3', borderRadius: 4, border: '1px solid rgba(192,50,26,.15)' }}>
                    + {plan.addon}
                  </div>
                )}
