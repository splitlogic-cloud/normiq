        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 72 }}>
            ...
            <h2 className="cg" style={{ fontSize: 'clamp(32px,4vw,52px)', color: 'white', marginBottom: 20, letterSpacing: '-.025em', lineHeight: 1.05 }}>
              Från fråga till verifierat svar.{' '}
              <em style={{ color: '#C0321A', fontStyle: 'italic' }}>Automatiskt.</em>
            </h2>
            ...
            {[
              {
                num: '01',
                title: 'Tax Brain',
                desc: 'Klistra in ett kvitto eller hämta transaktioner från Fortnox. Tax Brain föreslår BAS-konto, momskod och lagrum deterministiskt — inte av AI-gissning.',
                items: ['Kvitto → kontering på sekunder', 'Deterministisk momsberäkning', 'Godkänn, justera eller avvisa', 'Skicka direkt till Fortnox'],
              },
              {
                num: '02',
                title: 'Byråvy',
                desc: 'Hantera alla klienter under ett tak. Varje klient har egen Fortnox-koppling, transaktionshistorik och aktivitetslogg. Byt klient med ett klick.',
                items: ['Obegränsat antal klienter', 'Fortnox & Bokio OAuth-integration', 'Klientspecifik historik och statistik', 'Teammedlemmar med rollstyrning'],
              },
              {
                num: '03',
                title: 'Kunskapsbibliotek',
                desc: 'Normiq lär sig av varje verifierat svar. Revisorverifierade svar återanvänds automatiskt — liknande frågor besvaras direkt utan att belasta AI:n.',
                items: ['Revisor verifierar och godkänner svar', 'Automatisk återanvändning vid 88% likhet', 'Anonymt frågeregister och FAQ', 'Bygg byråns egen kunskapsbas'],
              },
            ].map((col, i) => (
            ...
            {[
              {
                ...
                features: ['1 användare', 'Advisor — källbaserade svar', 'Riskklassning per fråga', 'Klickbara lagrum'],
                addon: 'Tax Brain tillkommer +100 kr/mån',
              ...
              },
              {
                ...
                features: ['Upp till 10 användare', 'Advisor — källbaserade svar', 'Tax Brain ingår', 'Byråvy med klienthantering', 'Prioriterad support'],
                addon: null,
                cta: 'Starta Team',
              ...
              },
              {
                name: 'Byrå',
                price: '299',
                period: 'kr/klient/mån',
                desc: 'För redovisningsbyråer med flera klienter. Betala per klient, inte per användare.',
                features: ['Obegränsade användare', 'Allt i Team', 'Fortnox & Bokio-integration', 'Kunskapsbibliotek', 'Klientspecifik historik'],
                addon: null,
                cta: 'Kontakta oss',
